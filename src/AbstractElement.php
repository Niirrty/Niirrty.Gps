...
abstract class AbstractElement extends ExplicitGetter
{
    ...
    * @throws \Niirrty\Gps\GpsException If the direction does not match the based latitude or longitude element.
    */
    ...
    * @throws \Niirrty\Gps\GpsException If the direction is defined outside the allowed range, depending to Direction.
    */
    ...
    * @throws \Niirrty\Gps\GpsException If the minutes is wrong.
    */
