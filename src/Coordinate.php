...
class Coordinate
{
     ...
     * @param Coordinate|null &$output              Returns the resulting Coordinate reference, if the method returns
     *                                              TRUE
     *
     * @return boolean
        ...
        string $separator = ' ' ): string
    {
        ...
        return $this->Latitude->formatDMS( $reverse, $withoutSpaces, $secondsDecimalPlaces )
        ...
        bool $withoutSpaces = false, int $secondsDecimalPlaces = 3, string $separator = ' ' ): string
    {
        ...
        return $this->Latitude->formatDcMcS( $withoutSpaces, $secondsDecimalPlaces )
               . ( empty( $separator ) ? ' ' : $separator )
        ...
        bool $showMinuteChar = true, int $minutesDecimalPlaces = 6, string $separator = ' ' ): string
    {
        ...
        return $this->Latitude->formatDM( $showMinuteChar, $minutesDecimalPlaces )
               . ( empty( $separator ) ? ' ' : $separator )
        ...
        bool $showMinuteChar = false, int $minutesDecimalPlaces = 6, string $separator = ' ' ): string
    {
        ...
        return $this->Latitude->formatWithoutDirection( $showMinuteChar, $minutesDecimalPlaces )
               . ( empty( $separator ) ? ', ' : $separator )
    ...
    public final function formatExifLike(): string
    {
        ...
        return $this->Latitude->formatExifLike()
               . ', '
