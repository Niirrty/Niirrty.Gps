...
class Coordinate
{
   ...
   /**
    * @var \Niirrty\Gps\Longitude
    */
   public $Longitude;

   /**
    * @var \Niirrty\Gps\Latitude
    */
   public $Latitude;
    ...
    * Init a new instance.
    *
    * @param  \Niirrty\Gps\Latitude|string|double $latitude
    * @param  \Niirrty\Gps\Longitude|string|double $longitude
   ...
   /**
    * Extracts a {@see \Niirrty\Gps\Coordinate} instance from defined string value and returns it by reference with the
    * $output parameter. The Method returns TRUE on success, FALSE otherwise.
    *
    * @param  string  $str The string to parse
    * @param  \Niirrty\Gps\Coordinate|null &$output Returns the resulting Coordinate reference, if the method returns TRUE
    * @return boolean
    */
    ...
    * $output parameter. The Method returns TRUE on success, FALSE otherwise.
    *
    * @param  string|double|float|\Niirrty\Gps\Coordinate $value The value to parse.
    * @param  \Niirrty\Gps\Coordinate|null &$output Returns the resulting Coordinate reference, if the method returns TRUE
    * @return boolean
    */
   ...
   /**
    * See {@see \Niirrty\Gps\Coordinate::formatDMS()}.
    *
    * @return string
    */
    ...
    *
    * @param \Niirrty\Gps\Coordinate $otherPoint
    * @return integer
    */
