...
class Latitude extends AbstractElement
{
    ...
    * @throws \Niirrty\Gps\GpsException             Is thrown if an parameter it invalid.
    */
    ...
    * @param \Niirrty\Gps\Latitude|null &$output Returns the resulting Latitude reference, if the method returns TRUE
    * @return boolean
    */
    ...
    * $output parameter. The Method returns TRUE on success, FALSE otherwise.
    *
    * @param  string|double|float|\SimpleXMLElement|\Niirrty\Gps\Latitude|\Niirrty\Gps\Coordinate $value
    * @param  \Niirrty\Gps\Latitude|null &$output Returns the resulting Latitude reference, if the method returns TRUE
    * @return boolean
    */
