...
class Longitude extends AbstractElement
{
    ...
    *
    * @param  string|double|float|\SimpleXMLElement|\Niirrty\Gps\Longitude|\Niirrty\Gps\Coordinate $value
    ...
    * @param \Niirrty\Gps\Longitude|null &$output Returns the resulting Longitude reference, if the method returns TRUE
    * @return boolean
    */
